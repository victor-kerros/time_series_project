...
acf(dfertilizer); pacf(dfertilizer)
```
...
ar1ma2 <- arima(fertilizer, c(6,1,7), include.mean=F)
ar1ma1 <- arima(fertilizer, c(2,1,1), include.mean=F)
...
Qtests(ar1ma1$residuals, 24, fitdf=1)
