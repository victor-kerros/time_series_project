...
``` {r import dataset}
datafile <- "amy_valeurs_mensuelles.csv"
...
ar1ma1 <- arima(logwine, c(1,1,2), optim.control=list(maxit=20000))
ma1 <- arima(logwine, c(0,1,3), optim.control=list(maxit=20000))
